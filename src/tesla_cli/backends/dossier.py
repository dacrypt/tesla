...
OPTION_CODE_MAP: dict[str, tuple[str, str, str]] = {
    ...
    "MT300": ("motor", "Standard Range Rear-Wheel Drive", "Tracción trasera alcance estándar"),
    ...
    "IPB0": ("interior", "Premium Black Interior", "Interior Premium Negro"),
    "IPB1": ("interior", "Premium Black Interior", "Interior Premium Negro"),
    "IPB12": ("interior", "Premium Black Interior Gen 12 (Juniper)", "Interior Premium Negro Gen 12 (Juniper)"),
    "IPW0": ("interior", "Premium White Interior", "Interior Premium Blanco"),
    "IPW1": ("interior", "Premium White Interior", "Interior Premium Blanco"),
    "IBB0": ("interior", "Basic Black Interior", "Interior Básico Negro"),
    "IBW0": ("interior", "Basic White Interior", "Interior Básico Blanco"),
    "WY18B": ("wheels", "18\" Aero Wheels", "Rines 18\" Aero"),
    "WY19P": ("wheels", "19\" Gemini Wheels", "Rines 19\" Gemini"),
    "WY20A": ("wheels", "20\" Induction Wheels", "Rines 20\" Induction"),
    "WY20P": ("wheels", "20\" Performance Wheels", "Rines 20\" Performance"),
    "W38B": ("wheels", "18\" Aero Wheels", "Rines 18\" Aero"),
    "W39B": ("wheels", "19\" Sport Wheels", "Rines 19\" Sport"),
    "W40B": ("wheels", "19\" Gemini Wheels", "Rines 19\" Gemini"),
    "W41B": ("wheels", "20\" Überturbine Wheels", "Rines 20\" Überturbine"),
    "STY5S": ("seats", "5-Seat Interior", "Interior 5 Asientos"),
    "STY7S": ("seats", "7-Seat Interior", "Interior 7 Asientos"),
    "ST0Y": ("seats", "5-Seat Interior", "Interior 5 Asientos"),
    "APFA": ("autopilot", "Autopilot (basic: TACC + Autosteer)", "Autopilot (básico: TACC + Autosteer)"),
    "APFB": ("autopilot", "Autopilot (basic: TACC + Autosteer)", "Autopilot (básico: TACC + Autosteer)"),
    "APF0": ("autopilot", "No Autopilot", "Sin Autopilot"),
    "APF1": ("autopilot", "Enhanced Autopilot", "Autopilot Mejorado"),
    "APF2": ("autopilot", "Full Self-Driving", "Conducción Autónoma Completa"),
    "APH3": ("autopilot", "Autopilot HW3.0", "Autopilot HW3.0"),
    "APPA": ("autopilot", "Autopilot (post-2024)", "Autopilot (post-2024)"),
    ...
    "SC05": ("charging", "Free Supercharging (transfer ok)", "Supercharging Gratis (transferible)"),
    "CPF0": ("connectivity", "Standard Connectivity (basic)", "Conectividad Estándar (básica)"),
