...
_STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        # automations
        "automations.no_rules": "No automation rules configured. Run: tesla automations add",
        "automations.rule_added": "Rule '{name}' added",
        "automations.rule_removed": "Rule '{name}' removed",
        "automations.rule_enabled": "Rule '{name}' enabled",
        "automations.rule_disabled": "Rule '{name}' disabled",
        "automations.daemon_started": "Automations daemon started (Ctrl+C to stop)",
        "automations.daemon_stopped": "Automations daemon stopped",
        "automations.rule_fired": "Rule '{name}' fired: {message}",
        # energy
        "energy.no_sites": "No energy sites found on this account",
        "energy.site_info": "Energy site: {name}",
        "energy.backup_set": "Backup reserve set to {percent}%",
        "energy.mode_set": "Operation mode set to {mode}",
        "energy.storm_on": "Storm watch enabled",
        "energy.storm_off": "Storm watch disabled",
        # telemetry
        "telemetry.not_installed": "Fleet telemetry not installed. Run: tesla telemetry install",
        "telemetry.installed": "Fleet telemetry installed at {hostname}",
        "telemetry.started": "Fleet telemetry server started",
        "telemetry.stopped": "Fleet telemetry server stopped",
        "telemetry.configured": "Streaming configured for VIN {vin}",
        # scenes
        "scenes.morning": "Good morning! Here's your Tesla briefing:",
        "scenes.goodnight": "Goodnight check:",
        "scenes.trip": "Trip preparation:",
        # errors
    ...
    "es": {
        ...
        # automatizaciones
        "automations.no_rules": "No hay reglas configuradas. Ejecuta: tesla automations add",
        "automations.rule_added": "Regla '{name}' agregada",
        "automations.rule_removed": "Regla '{name}' eliminada",
        "automations.rule_enabled": "Regla '{name}' habilitada",
        "automations.rule_disabled": "Regla '{name}' deshabilitada",
        "automations.daemon_started": "Daemon de automatizaciones iniciado (Ctrl+C para detener)",
        "automations.daemon_stopped": "Daemon de automatizaciones detenido",
        "automations.rule_fired": "Regla '{name}' disparada: {message}",
        # energía
        "energy.no_sites": "No se encontraron sitios de energía en esta cuenta",
        "energy.site_info": "Sitio de energía: {name}",
        "energy.backup_set": "Reserva de respaldo configurada a {percent}%",
        "energy.mode_set": "Modo de operación configurado a {mode}",
        "energy.storm_on": "Vigilancia de tormentas activada",
        "energy.storm_off": "Vigilancia de tormentas desactivada",
        # telemetría
        "telemetry.not_installed": "Telemetría no instalada. Ejecuta: tesla telemetry install",
        "telemetry.installed": "Telemetría instalada en {hostname}",
        "telemetry.started": "Servidor de telemetría iniciado",
        "telemetry.stopped": "Servidor de telemetría detenido",
        "telemetry.configured": "Streaming configurado para VIN {vin}",
        # escenas
        "scenes.morning": "¡Buenos días! Tu briefing de Tesla:",
        "scenes.goodnight": "Revisión nocturna:",
        "scenes.trip": "Preparación para viaje:",
        # errores
    ...
    "pt": {
        ...
        # automações
        "automations.no_rules": "Nenhuma regra configurada. Execute: tesla automations add",
        "automations.rule_added": "Regra '{name}' adicionada",
        "automations.rule_removed": "Regra '{name}' removida",
        "automations.rule_enabled": "Regra '{name}' ativada",
        "automations.rule_disabled": "Regra '{name}' desativada",
        "automations.daemon_started": "Daemon de automações iniciado (Ctrl+C para parar)",
        "automations.daemon_stopped": "Daemon de automações parado",
        "automations.rule_fired": "Regra '{name}' disparada: {message}",
        # energia
        "energy.no_sites": "Nenhum site de energia encontrado nesta conta",
        "energy.site_info": "Site de energia: {name}",
        "energy.backup_set": "Reserva de backup definida para {percent}%",
        "energy.mode_set": "Modo de operação definido para {mode}",
        "energy.storm_on": "Modo tempestade ativado",
        "energy.storm_off": "Modo tempestade desativado",
        # telemetria
        "telemetry.not_installed": "Telemetria não instalada. Execute: tesla telemetry install",
        "telemetry.installed": "Telemetria instalada em {hostname}",
        "telemetry.started": "Servidor de telemetria iniciado",
        "telemetry.stopped": "Servidor de telemetria parado",
        "telemetry.configured": "Streaming configurado para VIN {vin}",
        # cenas
        "scenes.morning": "Bom dia! Seu resumo Tesla:",
        "scenes.goodnight": "Verificação noturna:",
        "scenes.trip": "Preparação para viagem:",
        # erros
    ...
    "fr": {
        ...
        # automatisations
        "automations.no_rules": "Aucune règle configurée. Exécutez : tesla automations add",
        "automations.rule_added": "Règle '{name}' ajoutée",
        "automations.rule_removed": "Règle '{name}' supprimée",
        "automations.rule_enabled": "Règle '{name}' activée",
        "automations.rule_disabled": "Règle '{name}' désactivée",
        "automations.daemon_started": "Démon d'automatisations démarré (Ctrl+C pour arrêter)",
        "automations.daemon_stopped": "Démon d'automatisations arrêté",
        "automations.rule_fired": "Règle '{name}' déclenchée : {message}",
        # énergie
        "energy.no_sites": "Aucun site d'énergie trouvé sur ce compte",
        "energy.site_info": "Site d'énergie : {name}",
        "energy.backup_set": "Réserve de secours définie à {percent}%",
        "energy.mode_set": "Mode de fonctionnement défini sur {mode}",
        "energy.storm_on": "Surveillance des tempêtes activée",
        "energy.storm_off": "Surveillance des tempêtes désactivée",
        # télémétrie
        "telemetry.not_installed": "Télémétrie Fleet non installée. Exécutez : tesla telemetry install",
        "telemetry.installed": "Télémétrie Fleet installée sur {hostname}",
        "telemetry.started": "Serveur de télémétrie démarré",
        "telemetry.stopped": "Serveur de télémétrie arrêté",
        "telemetry.configured": "Streaming configuré pour le VIN {vin}",
        # scènes
        "scenes.morning": "Bonjour ! Voici votre briefing Tesla :",
        "scenes.goodnight": "Vérification de nuit :",
        "scenes.trip": "Préparation du voyage :",
        # erreurs
    ...
    "de": {
        ...
        # Automatisierungen
        "automations.no_rules": "Keine Automatisierungsregeln konfiguriert. Ausführen: tesla automations add",
        "automations.rule_added": "Regel '{name}' hinzugefügt",
        "automations.rule_removed": "Regel '{name}' entfernt",
        "automations.rule_enabled": "Regel '{name}' aktiviert",
        "automations.rule_disabled": "Regel '{name}' deaktiviert",
        "automations.daemon_started": "Automatisierungs-Daemon gestartet (Strg+C zum Stoppen)",
        "automations.daemon_stopped": "Automatisierungs-Daemon gestoppt",
        "automations.rule_fired": "Regel '{name}' ausgelöst: {message}",
        # Energie
        "energy.no_sites": "Keine Energiestandorte auf diesem Konto gefunden",
        "energy.site_info": "Energiestandort: {name}",
        "energy.backup_set": "Backup-Reserve auf {percent}% gesetzt",
        "energy.mode_set": "Betriebsmodus auf {mode} gesetzt",
        "energy.storm_on": "Sturmüberwachung aktiviert",
        "energy.storm_off": "Sturmüberwachung deaktiviert",
        # Telemetrie
        "telemetry.not_installed": "Fleet-Telemetrie nicht installiert. Ausführen: tesla telemetry install",
        "telemetry.installed": "Fleet-Telemetrie auf {hostname} installiert",
        "telemetry.started": "Telemetrie-Server gestartet",
        "telemetry.stopped": "Telemetrie-Server gestoppt",
        "telemetry.configured": "Streaming für VIN {vin} konfiguriert",
        # Szenen
        "scenes.morning": "Guten Morgen! Hier ist Ihr Tesla-Briefing:",
        "scenes.goodnight": "Nacht-Check:",
        "scenes.trip": "Reisevorbereitung:",
        # Fehler
    ...
    "it": {
        ...
        # Automazioni
        "automations.no_rules": "Nessuna regola di automazione configurata. Eseguire: tesla automations add",
        "automations.rule_added": "Regola '{name}' aggiunta",
        "automations.rule_removed": "Regola '{name}' rimossa",
        "automations.rule_enabled": "Regola '{name}' abilitata",
        "automations.rule_disabled": "Regola '{name}' disabilitata",
        "automations.daemon_started": "Daemon delle automazioni avviato (Ctrl+C per fermare)",
        "automations.daemon_stopped": "Daemon delle automazioni fermato",
        "automations.rule_fired": "Regola '{name}' scattata: {message}",
        # Energia
        "energy.no_sites": "Nessun sito energetico trovato su questo account",
        "energy.site_info": "Sito energetico: {name}",
        "energy.backup_set": "Riserva di backup impostata al {percent}%",
        "energy.mode_set": "Modalità operativa impostata su {mode}",
        "energy.storm_on": "Monitoraggio tempeste attivato",
        "energy.storm_off": "Monitoraggio tempeste disattivato",
        # Telemetria
        "telemetry.not_installed": "Telemetria Fleet non installata. Eseguire: tesla telemetry install",
        "telemetry.installed": "Telemetria Fleet installata su {hostname}",
        "telemetry.started": "Server di telemetria avviato",
        "telemetry.stopped": "Server di telemetria fermato",
        "telemetry.configured": "Streaming configurato per VIN {vin}",
        # Scene
        "scenes.morning": "Buongiorno! Ecco il tuo briefing Tesla:",
        "scenes.goodnight": "Controllo notturno:",
        "scenes.trip": "Preparazione al viaggio:",
        # Errori
